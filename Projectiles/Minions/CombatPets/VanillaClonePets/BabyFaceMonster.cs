...
namespace AmuletOfManyMinions.Projectiles.Minions.CombatPets.VanillaClonePets
{
	...
	{
		public BabyFaceMonsterMinionBuff() : base(ProjectileType<BabyFaceMonsterMinion>()) { }
	...
	{
		public override string Texture => "Terraria/Projectile_" + ProjectileID.BabyFaceMonster;
