...
namespace AmuletOfManyMinions.Projectiles.Minions.CombatPets.VanillaClonePets
{
	...
	{
		public SpiderPetMinionBuff() : base(ProjectileType<SpiderPetMinion>()) { }
	...
	public class SpiderPetMinion : BaseSpiderMinion
	{
		...
		public override string Texture => "Terraria/Projectile_" + ProjectileID.Spider;
		...
		public override Vector2 IdleBehavior()
		{
			...
			SetOriginalDamage(leveledPetPlayer.PetDamage);
