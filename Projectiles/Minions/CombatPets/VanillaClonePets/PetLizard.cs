...
namespace AmuletOfManyMinions.Projectiles.Minions.CombatPets.VanillaClonePets
{
	...
	{
		public PetLizardMinionBuff() : base(ProjectileType<PetLizardMinion>()) { }
	...
	{
		public override string Texture => "Terraria/Projectile_" + ProjectileID.PetLizard;
		internal override int BuffId => BuffType<PetLizardMinionBuff>();
