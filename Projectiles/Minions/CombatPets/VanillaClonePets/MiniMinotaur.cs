...
namespace AmuletOfManyMinions.Projectiles.Minions.CombatPets.VanillaClonePets
{
	...
	{
		public MiniMinotaurMinionBuff() : base(ProjectileType<MiniMinotaurMinion>()) { }
	...
	{
		public override string Texture => "Terraria/Item_" + ItemID.LeadAxe;
	...
	{
		public override string Texture => "Terraria/Projectile_" + ProjectileID.MiniMinotaur;
